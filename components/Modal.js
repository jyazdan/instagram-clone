...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    // 1) Create a cost and add to firestore 'posts' collection
            ...
            >
              <div>
                ...
                <div className="mt-5 sm:mt-6">
                  ...
                  text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500
